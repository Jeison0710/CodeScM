MODULE prob_param
  ...
  INTEGER(ITT) ::  ntot,nlarg,nlard,nt,nt1
  INTEGER(ITT) ::  nshow,V0_switch
...
MODULE bspline_module
  USE nrtype
  INTEGER(ITT) :: nmax,n,l,l0
  INTEGER(ITT), ALLOCATABLE :: indexb(:,:),index_xd(:)
  REAL(RT) :: dx,bint
...
!************  modules for backward substitution ************
 ...
 module detbx
   USE nrtype
   IMPLICIT NONE
   REAL(RT), DIMENSION(:,:), ALLOCATABLE :: d,dd1,dd2,dd0,dxx,dxx1,dxx2,dxx0
   REAL(RT):: theta
 end module detbx
